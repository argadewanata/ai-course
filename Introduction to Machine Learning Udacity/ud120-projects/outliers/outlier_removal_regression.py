...
net_worths = joblib.load(
    open("./outliers/practice_outliers_net_worths.pkl", "rb"))
...
print(f"R-Squared Score on Training Dataset: {reg.score(ages_train, net_worths_train)}")
print(f"R-Squared Score on Test Dataset: {reg.score(ages_test, net_worths_test)}\n")
